...
##################################A549##############################################
setwd("/data2t_2/hushu/02.DESeq2_analysis_TE_loci/")
##A549 celltype Virus_IAV_11 dataset Post_360m vs Pre_0m
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_A549_n248.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_IAV_11_readscounts_matrix_TE_Loci.txt",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_A549_n248.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_IAV_3_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/A549",
  dataset        = "Virus_IAV_3",
  cond1          = "Pre_360m",
  cond2          = "Post_360m"
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_A549_n248.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_RSV_1_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/A549",
  dataset        = "Virus_RSV_1",
  cond1          = "Pre_0m",
  cond2          = "Post_1440m"
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_A549_n248.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_IAV_6_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/A549",
  dataset        = "Virus_IAV_6",
  cond1          = "Pre_240m",
  cond2          = "Post_240m"
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_A549_n248.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_SARSCoV2_10_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/A549",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_A549_n248.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_SARSCoV2_9_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/A549",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_A549_n248.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_IAV_9_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/A549",
  dataset        = "Virus_IAV_9",
  cond1          = "Pre_1440m",
  cond2          = "Post_1440m"
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_A549_n248.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_IAV_2_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/A549",
  dataset        = "Virus_IAV_2",
  cond1          = "Pre_60m",
  cond2          = "Post_60m"
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_A549_n248.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Bacteria_Spn_2_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/A549",
...
###合并同一个species的差异基因
###A549 Virus_IAV
setwd("/data2t_2/hushu/02.DESeq2_analysis_TE_loci/DE_results/A549/")
union_DE_genes_TE_loci(
  prefix = "Virus_IAV",
  suffix = "sig_DE-TEs_padj0.05log2FC0.5.csv",
  outDir = "./"
)
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_Macrophages_n986.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Bacteria_Lmo_1_readscounts_matrix_TE_Loci.txt",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_Macrophages_n986.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Bacteria_Lmo_4_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/Macrophages/",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_Macrophages_n986.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Bacteria_MTB_4_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/Macrophages/",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_Macrophages_n986.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Bacteria_MTB_6_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/Macrophages/",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_Macrophages_n986.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Bacteria_MTB_8_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/Macrophages/",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_Macrophages_n986.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Bacteria_NTHi_1_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/Macrophages/",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_Macrophages_n986.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Bacteria_SalEn_1_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/Macrophages/",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_Macrophages_n986.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Bacteria_SalTy_4_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/Macrophages/",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_Macrophages_n986.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Fungi_Af_4_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/Macrophages/",
  dataset        = "Fungi_Af_4",
  cond1          = "Pre_0m",
  cond2          = "Post_120m"
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_Macrophages_n986.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Fungi_Af_6_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/Macrophages/",
  dataset        = "Fungi_Af_6",
  cond1          = "Pre_0m",
  cond2          = "Post_60m"
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_Macrophages_n986.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Fungi_Af_8_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/Macrophages/",
  dataset        = "Fungi_Af_8",
  cond1          = "Pre_120m",
  cond2          = "Post_120m"
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_Macrophages_n986.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_IAV_9_Macrophages_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/Macrophages/",
  dataset        = "Virus_IAV_9",
  cond1          = "Pre_0m",
  cond2          = "Post_1440m"
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_Macrophages_n986.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_SARSCoV2_1_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/Macrophages/",
...
###################################
setwd("/data2t_2/hushu/02.DESeq2_analysis_TE_loci/DE_results/Macrophages/")
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_B_cell_n85.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_EBV_2_readscounts_matrix_TE_Loci.txt",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_B_cell_n85.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/new_all_sample_readscounts_matrix_combined_n4842_TE_subfamily.txt",
  outDir         = "DE_results/B_cell/",
  dataset        = "Virus_EBV_2",
  cond1          = "Pre_0m",
  cond2          = "Post_10080m"
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_B_cell_n85.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_EBV_4_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/B_cell/",
  dataset        = "Virus_EBV_4",
  cond1          = "Pre_1440m",
  cond2          = "Post_1440m"
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_B_cell_n85.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_EBV_5_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/B_cell/",
  dataset        = "Virus_EBV_5",
  cond1          = "Pre_0m",
  cond2          = "Post_2880m"
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_B_cell_n85.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Protozoa_Pf_5_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/B_cell/",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_B_cell_n85.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_HBV_1_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/B_cell/",
  dataset        = "Virus_HBV_1",
  cond1          = "Pre_120m",
  cond2          = "Post_120m"
...
#########################
###B_cell Virus_HBV
setwd("/data2t_2/hushu/02.DESeq2_analysis_TE_loci/DE_results/B_cell/")
union_DE_genes_TE_loci(
  prefix = "Virus_HBV",
  suffix = "sig_DE-TEs_padj0.05log2FC0.5.csv",
  outDir = "./"
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_T_cell_n108.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_HBV_1_readscounts_matrix_TE_Loci.txt",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_T_cell_n108.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_HIV1_10_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/T_cell/",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_T_cell_n108.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_HIV1_11_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/T_cell/",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_T_cell_n108.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_HIV1_14_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/T_cell/",
...
#########################
###T_cell Virus_HBV
setwd("/data2t_2/hushu/02.DESeq2_analysis_TE_loci/DE_results/T_cell/")
union_DE_genes_TE_loci(
  prefix = "Virus_HBV",
  suffix = "sig_DE-TEs_padj0.05log2FC0.5.csv",
  outDir = "./"
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_Liver_n176.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_HBV_2_readscounts_matrix_TE_Loci.txt",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_Liver_n176.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_HBV_5_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/Liver/",
  dataset        = "Virus_HBV_5",
  cond1          = "Pre_2880m",
  cond2          = "Post_2880m"
...
#########################
setwd("/data2t_2/hushu/02.DESeq2_analysis_TE_loci/DE_results/Liver/")
###Liver Virus_HBV
union_DE_genes_TE_loci(
  prefix = "Virus_HBV",
  suffix = "sig_DE-TEs_padj0.05log2FC0.5.csv",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_PBMCs_n243.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Fungi_Af_9_readscounts_matrix_TE_Loci.txt",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_PBMCs_n243.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Protozoa_Pf_2_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/PBMCs/",
...
#########################
setwd("/data2t_2/hushu/02.DESeq2_analysis_TE_loci/DE_results/PBMCs/")
###PBMCs Fungi_Af
union_DE_genes_TE_loci(
  prefix = "Fungi_Af",
  suffix = "sig_DE-TEs_padj0.05log2FC0.5.csv",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_Monocyte_n283.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Bacteria_Lmo_6_readscounts_matrix_TE_Loci.txt",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_Monocyte_n283.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Virus_RSV_5_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/Monocyte/",
  dataset        = "Virus_RSV_5",
  cond1          = "Pre_1440m",
...
#########################
setwd("/data2t_2/hushu/02.DESeq2_analysis_TE_loci/DE_results/Monocyte/")
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_Dendritic_n289.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Bacteria_Bpe_2_readscounts_matrix_TE_Loci.txt",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_Dendritic_n289.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Bacteria_Sau_2_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/Dendritic/",
...
TE_DE_analysis(
  metadata_file  = "/home/hushu/pathogen_TE_2025/02.DESeq2_analysis/raw_data/new_all_sample_info_Dendritic_n289.xlsx",
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_loci/raw_data/Protozoa_Pf_6_readscounts_matrix_TE_Loci.txt",
  outDir         = "DE_results/Dendritic/",
...
#########################
setwd("/data2t_2/hushu/02.DESeq2_analysis_TE_loci/DE_results/Dendritic/")
