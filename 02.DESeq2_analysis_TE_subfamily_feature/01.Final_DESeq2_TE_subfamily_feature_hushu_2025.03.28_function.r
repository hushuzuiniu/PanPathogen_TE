...
##################################A549##############################################
setwd("/data2t_2/hushu/02.DESeq2_analysis_TE_subfamily_feature_v2")
...
TE_DE_analysis(
  ...
  raw_count_file = "/data2t_2/hushu/02.DESeq2_analysis_TE_subfamily_feature_v2/raw_data/new_all_sample_readscounts_matrix_combined_n4231_TE_subfamily_feature_v2.txt",
...
#############################################################################
###A549 Virus_IAV
setwd("/data2t_2/hushu/02.DESeq2_analysis_TE_subfamily_feature_v2/DE_results/A549/")
union_DE_genes(
  prefix = "Virus_IAV",
  suffix = "sig_DE-TEs_feature_padj0.05log2FC0.5.csv",
  outDir = "./"
)
...
##################################################################
setwd("/data2t_2/hushu/02.DESeq2_analysis_TE_subfamily_feature_v2/DE_results/Macrophages/")
...
#########################
###B_cell Virus_HBV
setwd("/data2t_2/hushu/02.DESeq2_analysis_TE_subfamily_feature_v2/DE_results/B_cell/")
union_DE_genes(
  prefix = "Virus_HBV",
  suffix = "sig_DE-TEs_feature_padj0.05log2FC0.5.csv",
  outDir = "./"
...
#########################
###T_cell Virus_HBV
setwd("/data2t_2/hushu/02.DESeq2_analysis_TE_subfamily_feature_v2/DE_results/T_cell/")
union_DE_genes(
  prefix = "Virus_HBV",
  suffix = "sig_DE-TEs_feature_padj0.05log2FC0.5.csv",
  outDir = "./"
...
#########################
setwd("/data2t_2/hushu/02.DESeq2_analysis_TE_subfamily_feature_v2/DE_results/Liver/")
###Liver Virus_HBV
union_DE_genes(
  prefix = "Virus_HBV",
  suffix = "sig_DE-TEs_feature_padj0.05log2FC0.5.csv",
...
#########################
setwd("/data2t_2/hushu/02.DESeq2_analysis_TE_subfamily_feature_v2/DE_results/PBMCs/")
###PBMCs Fungi_Af
union_DE_genes(
  prefix = "Fungi_Af",
  suffix = "sig_DE-TEs_feature_padj0.05log2FC0.5.csv",
...
#########################
setwd("/data2t_2/hushu/02.DESeq2_analysis_TE_subfamily_feature_v2/DE_results/Monocyte/")
...
#########################
setwd("/data2t_2/hushu/02.DESeq2_analysis_TE_subfamily_feature_v2/DE_results/Dendritic/")
