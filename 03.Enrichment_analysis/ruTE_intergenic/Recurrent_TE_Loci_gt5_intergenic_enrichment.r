...
recurrent_up_intergenic_TE_Loci<-read.csv("/data2t_2/pathogen_TE_2025_New/02.DESeq2_analysis_TE_loci/plots/Recurrent_Up_TE_Loci_intergenic_UniqPathogens_gt1.csv")
table(recurrent_up_intergenic_TE_Loci$UniqPathogens)
gt5_Up_TE_Loci<-recurrent_up_intergenic_TE_Loci[recurrent_up_intergenic_TE_Loci$UniqPathogens>=5,]
...
write.table(final_result, file = "/data2t_2/pathogen_TE_2025_New/03.Enrichment_analysis/Recurrent_TE_Loci_gt5_intergenic_n838.bed", row.names = FALSE,col.names = FALSE,quote = FALSE,sep = "\t")

##################bedtools linux########################################################################
cd /data2t_2/pathogen_TE_2025_New/03.Enrichment_analysis
bedtools sort -g /data2t_2/hushu/00.ref/hg38.p13.fa.fai -i Recurrent_TE_Loci_gt5_intergenic_n838.bed > Recurrent_TE_Loci_gt5_intergenic_n838.genome.sorted.bed
...
bedtools closest -a Recurrent_TE_Loci_gt5_intergenic_n838.genome.sorted.bed -b /data2t_2/pathogen_TE_2025_New/01.Genomic_features_Gencode/genes_regions.standard_chr.sorted.bed -d -t first -k 1 > Recurrent_TE_Loci_gt5_intergenic_n838_closest_genes.bed
############################################################################################################
...
go_bp_df <- save_enrichment_results(go_bp, "Recurrent_TE_Loci_gt5_intergenic_n838_closest_genes_GOBP_enrichment")
go_mf_df <- save_enrichment_results(go_mf, "Recurrent_TE_Loci_gt5_intergenic_n838_closest_genes_GOMF_enrichment")
go_cc_df <- save_enrichment_results(go_cc, "Recurrent_TE_Loci_gt5_intergenic_n838_closest_genes_GOCC_enrichment")
kegg_df <- save_enrichment_results(kegg_result, "Recurrent_TE_Loci_gt5_intergenic_n838_closest_genes_KEGG_enrichment")
...
ggsave("Fig3_Recurrent_TE_Loci_gt5_intergenic_n838_closest_genes_GOBP_enrichment.pdf", gobp_plot, width = 6, height = 4)
ggsave("Fig3s_Recurrent_TE_Loci_gt5_intergenic_n838_closest_genes_GOCC_enrichment.pdf", gocc_plot, width = 8, height = 2)
ggsave("Fig3s_Recurrent_TE_Loci_gt5_intergenic_n838_closest_genes_GOMF_enrichment.pdf", gomf_plot, width = 8, height = 4)
ggsave("Fig3_Recurrent_TE_Loci_gt5_intergenic_n838_closest_genes_KEGG_enrichment.pdf", kegg_plot, width = 7, height = 4)
