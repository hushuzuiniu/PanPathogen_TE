...
##############################################################################################################################
##############################################################################################################################
### Merge differential genes from the same species
###A549 Virus_IAV
...
## A549 separate datasets to get up/down/no change results
setwd("/data2t_2/pathogen_TE_2025_New/02.DESeq2_analysis_TE_subfamily_feature/DE_results/A549/")
###A549 Virus_IAV_11
union_DE_genes(
  prefix = "Virus_IAV_11",
...
## Dendritic separate datasets to get up/down/no change results
setwd("/data2t_2/pathogen_TE_2025_New/02.DESeq2_analysis_TE_subfamily_feature/DE_results/Dendritic/")
union_DE_genes(
